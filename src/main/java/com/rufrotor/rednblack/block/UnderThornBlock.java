...
import com.rufrotor.rednblack.entity.damage.RNBDamageTypes;
import com.rufrotor.rednblack.util.DamageSourceCreator;
...
public class UnderThornBlock extends Block{
    public static final MapCodec<UnderThornBlock> CODEC = createCodec(UnderThornBlock::new);
    ...
    @Override
    public MapCodec<UnderThornBlock> getCodec() {
        return CODEC;
    }

    public UnderThornBlock(AbstractBlock.Settings settings) {
        super(settings);
        ...
        this.shapesByState = ImmutableMap.copyOf(
                (Map<? extends BlockState, ? extends VoxelShape>)this.stateManager
                        .getStates()
                        .stream()
                        .collect(Collectors.toMap(Function.identity(), UnderThornBlock::getShapeForState))
        );
    }
        ...
        if (entity instanceof LivingEntity) {
            ...
            if (!world.isClient  && (entity.lastRenderX != entity.getX() || entity.lastRenderZ != entity.getZ())) {
                ...
                if (d >= 0.003000000026077032 || e >= 0.003000000026077032) {
                    entity.damage(DamageSourceCreator.createDamageSource(entity, RNBDamageTypes.UNDER_THORN), 1.0F);
                }
            }
